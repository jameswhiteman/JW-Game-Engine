...
import jw.engine.abstracts.AbstractAnimatedObject;
...
public class AnimatedObject extends AbstractAnimatedObject implements Transformable, Playable, Serializable
{
    ...
    // Object properties. Whether or not it is solid, visible, the type of object it is, and its mask.
    ...
    /*
    public AnimatedObject(String name, ArrayList<BufferedImage> animation, double x, double y)
    {
        super(animation, name, x, y);
        maxlspeed = -25;
        maxrspeed = 25;
        maxuspeed = -25;
        maxrspeed = 25;
    ...
    public AnimatedObject(String name, ArrayList<BufferedImage> animation, double x, double y, int width,
    ...
    public AnimatedObject(String name, ArrayList<BufferedImage> animation, double x, double y, int width,
            int height, int depth, int rot, double xscale, double yscale, String objtype)
    {
        setName(name);
        setAnimation(animation);
        setX(x);
